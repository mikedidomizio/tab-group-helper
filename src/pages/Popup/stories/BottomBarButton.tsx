 ...
 */
export const BottomBarButton: FunctionComponent<BottomBarButtonInterface> = (props: PropsWithChildren<any>): ReactElement => {
    const classes = useStyles();
    return (
        <Box className={classes.root} component="span" mr={1}>
            <Tooltip title={props.tooltip} enterDelay={1000} placement={props.placement} leaveDelay={0}>
